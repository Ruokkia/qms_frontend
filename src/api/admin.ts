...
export const updateRolePermissions = (roleCode: string, data: { dataScope: string; permissions: string[]; reason: string }) => apiPut<RolePermission>(`/admin/roles/${roleCode}/permissions`, data)
